...
# if download fails (e.g. 403), fall back to generating locally with OpenRouter API
...
elif ! curl -fL -o "$IDENTITY_FILE" https://raw.githubusercontent.com/originalzen/nanochat/master/identity_conversations.jsonl; then
